# -*- coding: utf-8 -*-
"""
Created on Wed Jul 12 14:11:09 2017
...
class OutputLayer(FCLayer) :
    ...
    def back_propa(self, pre_mapset, current_error, learn_rate, isweight_update) :
        ...
        if isweight_update :
            # pre_mapset : 1x1x84
            weight_update = (self.weight - np.array(list(pre_mapset[0]) * self.weight.shape[0]))
    ...
    def softmax(self, pre_maps, node_index = -1) :
        ...
        output = np.matmul(self.weight,self.pre_nodes)   # 10 x 1
